package company.com.recording.song.model;
...
public class AddictedToYou extends Song {
    public AddictedToYou(){super(SongName.ADDICTEDTOYOU, SongGenre.ELECTRONIC,148);}
